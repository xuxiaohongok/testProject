...
public class DateUtil {
	 ...
	 * @return
	 */
	public static boolean compareDate(String SMALL_DATE, String MAX_DATE) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
		boolean isMax = false;
		try {
			Date dt1 = df.parse(SMALL_DATE);
			Date dt2 = df.parse(MAX_DATE);
			if (dt1.getTime() < dt2.getTime()) {
//				System.out.println(MAX_DATE + " 大于 " + SMALL_DATE);
				isMax = true;
			} //else System.out.println(MAX_DATE + " 小于或等于 " + SMALL_DATE);
  ...
  public static int compare_date(String DATE1, String DATE2) {
	...
	public static boolean isMax_date(String SMALL_DATE, String MAX_DATE) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
		boolean isMax = false;
		try {
			Date dt1 = df.parse(SMALL_DATE);
...
//	     System.out.println("i=="+ compareDate("2015-10-11"));
...
//		System.out.println((int)getDifferentTimeMillis());
		...
		System.out.println(23 - getHour() + 1);
